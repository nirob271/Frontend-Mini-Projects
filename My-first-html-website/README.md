...
Course overview with learning objectives

Detailed lecture notes on web fundamentals

Responsive design using HTML elements
...
Lecture 2: HTML Fundamentals - Heading, Paragraph, Anchor tags

Lecture 3: Advanced HTML elements

Lecture 4: HTML Nested Lists & Tables

Lecture 5: File Paths, Boilerplate Code, DIV, Class, ID
...
Implementing various HTML elements (tables, lists, forms)

Organizing content effectively using HTML
